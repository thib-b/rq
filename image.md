...
entries_layout: list
---
![Robocobra Quartet Press Shot 1]({{ site.url }}{{ site.baseurl }}/assets/images/RQ1.jpeg)
Press Shot ([Click here for hi-res download]({{ site.url }}{{ site.baseurl }}/assets/images/RQ1.jpeg))  
Photo credit: Colin Armstrong

![Robocobra Quartet Press Shot 2]({{ site.url }}{{ site.baseurl }}/assets/images/RQ2.jpeg)
